...
export default function BuscarUsuarioGrid(){
    ...
    async function getUsers(){
        const res = await fetch("https://bumpy-unicorn-brunogianini-8376417b.koyeb.app/usuarios/" + userId)
